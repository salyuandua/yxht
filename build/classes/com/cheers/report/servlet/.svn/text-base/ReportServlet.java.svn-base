package com.cheers.report.servlet;
...
import com.cheers.report.service.ReportThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Report"},name="Report",asyncSupported=true)
public class ReportServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ReportThread reportThread = new ReportThread(asyncContext,request.getSession());
