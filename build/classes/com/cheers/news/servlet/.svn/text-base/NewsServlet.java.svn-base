package com.cheers.news.servlet;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/News"},name="News",asyncSupported=true)
public class NewsServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		   ...
		   request.setCharacterEncoding("UTF-8");
	        ...
	        NewsHandleThread newsHandleThread = new NewsHandleThread(asyncContext,request.getSession());
