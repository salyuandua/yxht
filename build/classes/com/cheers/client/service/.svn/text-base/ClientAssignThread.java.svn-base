...
public class ClientAssignThread  implements Runnable{
	...
	private ClientAssignService service;
	public ClientAssignThread() {
		service = new ClientAssignService();
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public ClientAssignThread(AsyncContext asyncContext) {
		service = new ClientAssignService();
		this.asyncContext = asyncContext;
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public ClientAssignThread(AsyncContext asyncContext,HttpSession session) {
		service = new ClientAssignService();
		this.asyncContext = asyncContext;
