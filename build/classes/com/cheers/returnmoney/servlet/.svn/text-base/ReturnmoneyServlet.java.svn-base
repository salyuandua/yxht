package com.cheers.returnmoney.servlet;
...
import com.cheers.car.service.CarHandleThread;
import com.cheers.returnmoney.service.ReturnmoneyThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Returnmoney"},name="returnmoney",asyncSupported=true)
public class ReturnmoneyServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ReturnmoneyServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		   ...
		   request.setCharacterEncoding("UTF-8");
	        ...
	        ReturnmoneyThread carHandleThread = new ReturnmoneyThread(asyncContext,request.getSession());
	        asyncContext.start(carHandleThread);
	}
