...
public class ZhuJiMaThread  implements Runnable{
	...
	private ZhuJiMaService service;
	public ZhuJiMaThread() {
		service = new ZhuJiMaService();
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public ZhuJiMaThread(AsyncContext asyncContext) {
		service = new ZhuJiMaService();
		this.asyncContext = asyncContext;
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public ZhuJiMaThread(AsyncContext asyncContext,HttpSession session) {
		service = new ZhuJiMaService();
		this.asyncContext = asyncContext;
