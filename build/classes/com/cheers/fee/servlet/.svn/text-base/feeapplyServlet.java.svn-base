package com.cheers.fee.servlet;
...
import com.cheers.fee.service.feeapplyThread;
import com.cheers.mobile.service.MobileThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/FeeApply"},name="feeApply",asyncSupported=true)
public class feeapplyServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        feeapplyThread productHandleThread = new feeapplyThread(asyncContext,request.getSession());
