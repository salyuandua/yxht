...
public class RoleHandleThread implements Runnable{
	...
	public RoleHandleThread() {
		service = new RoleService();
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public RoleHandleThread(AsyncContext asyncContext) {
		service = new RoleService();
		this.asyncContext = asyncContext;
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public RoleHandleThread(AsyncContext asyncContext,HttpSession session) {
		service = new RoleService();
		this.asyncContext = asyncContext;
