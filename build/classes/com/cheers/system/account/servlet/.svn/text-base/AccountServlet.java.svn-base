package com.cheers.system.account.servlet;
...
import com.cheers.system.account.service.AccountHandleThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Account"},name="account",asyncSupported=true)
public class AccountServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		   ...
		   request.setCharacterEncoding("UTF-8");
	        ...
	        AccountHandleThread categoryHandleThread = new AccountHandleThread(asyncContext,request.getSession());
	        asyncContext.start(categoryHandleThread);
	}
