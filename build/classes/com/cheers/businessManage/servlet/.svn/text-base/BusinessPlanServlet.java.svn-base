package com.cheers.businessManage.servlet;
...
import com.cheers.businessManage.service.BusinessPlanThread;
import com.cheers.client.service.ClientThread;
/** 
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/BusinessPlan"},name="businessplan",asyncSupported=true)
public class BusinessPlanServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        BusinessPlanThread productHandleThread = new BusinessPlanThread(asyncContext,request.getSession());
