package com.cheers.mobile.servlet;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Mobile"},name="Mobile",asyncSupported=true)
public class MobileServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MobileThread productHandleThread = new MobileThread(asyncContext,request.getSession());
