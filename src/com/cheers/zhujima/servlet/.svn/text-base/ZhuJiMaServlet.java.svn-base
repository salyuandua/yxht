package com.cheers.zhujima.servlet;
...
import com.cheers.zhujima.service.ZhuJiMaThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Zhuji"},name="zhuji",asyncSupported=true)
public class ZhuJiMaServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ZhuJiMaThread productHandleThread = new ZhuJiMaThread(asyncContext,request.getSession());
