...
public class NewsHandleThread implements Runnable{
	...
	public NewsHandleThread() {
		service = new NewsService();
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public NewsHandleThread(AsyncContext asyncContext) {
		service = new NewsService();
		this.asyncContext = asyncContext;
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public NewsHandleThread(AsyncContext asyncContext,HttpSession session) {
		service = new NewsService();
		this.asyncContext = asyncContext;
