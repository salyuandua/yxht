package com.cheers.emails.servlet;
...
import com.cheers.emails.service.EmailsHandleThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Emails"},name="Emails",asyncSupported=true)
public class EmailsServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	        ...
	        EmailsHandleThread emailsHandleThread = new EmailsHandleThread(asyncContext,request.getSession());
	        asyncContext.start(emailsHandleThread);
	}
