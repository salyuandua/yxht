...
import com.cheers.sp.service.SpHandleThread;
/** 
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Sp"},name="sp",asyncSupported=true)
public class SpServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        SpHandleThread productHandleThread = new SpHandleThread(asyncContext,request.getSession());
