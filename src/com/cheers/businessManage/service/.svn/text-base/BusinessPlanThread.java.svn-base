...
public class BusinessPlanThread  implements Runnable{
	...
	private BusinessPlanService service;
	public BusinessPlanThread() {
		service = new BusinessPlanService();
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public BusinessPlanThread(AsyncContext asyncContext) {
		service = new BusinessPlanService();
		this.asyncContext = asyncContext;
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public BusinessPlanThread(AsyncContext asyncContext,HttpSession session) {
		service = new BusinessPlanService();
		this.asyncContext = asyncContext;
