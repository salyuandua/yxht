package com.cheers.location.servlet;
...
import com.cheers.location.service.LocationThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Location"},name="location",asyncSupported=true)
public class LocationServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        LocationThread productHandleThread = new LocationThread(asyncContext,request.getSession());
