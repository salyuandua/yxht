package com.cheers.order.servlet;
...
import com.cheers.order.service.OrderThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Order"},name="Order",asyncSupported=true)
public class OrderServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        OrderThread orderThread = new OrderThread(asyncContext,request.getSession());
