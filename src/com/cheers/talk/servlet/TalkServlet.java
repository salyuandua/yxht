package com.cheers.talk.servlet;
...
import com.cheers.talk.service.TalkThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Talk"},name="talk",asyncSupported=true)
public class TalkServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		   ...
		   request.setCharacterEncoding("UTF-8");
	        ...
	        TalkThread talkThread = new TalkThread(asyncContext,request.getSession());
	        asyncContext.start(talkThread);
	}
