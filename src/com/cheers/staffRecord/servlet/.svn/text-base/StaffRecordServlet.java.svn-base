package com.cheers.staffRecord.servlet;
...
import com.cheers.staffRecord.service.StaffRecordThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/StaffRecord"},name="staffRecord",asyncSupported=true)
public class StaffRecordServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public StaffRecordServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		   ...
		   request.setCharacterEncoding("UTF-8");
	        ...
	        StaffRecordThread staffRecordThread = new StaffRecordThread(asyncContext,request.getSession());
	        asyncContext.start(staffRecordThread);
	}
