package com.cheers.system.role.servlet;
...
import com.cheers.system.role.service.RoleHandleThread;
/** 
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Role"},name="role",asyncSupported=true)
public class RoleServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RoleHandleThread roleHandleThread = new RoleHandleThread(asyncContext,request.getSession());
        asyncContext.start(roleHandleThread);
	}
