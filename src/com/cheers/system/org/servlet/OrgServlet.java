package com.cheers.system.org.servlet;
...
import com.cheers.system.org.service.OrgHandleThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Org"},name="org",asyncSupported=true)
public class OrgServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        OrgHandleThread orgHandleThread = new OrgHandleThread(asyncContext,request.getSession());
