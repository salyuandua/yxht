package com.cheers.system.baseData.servlet;
...
import com.cheers.system.baseData.service.BaseDataThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/baseData"},name="baseData",asyncSupported=true)
public class BaseDataServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        BaseDataThread productHandleThread = new BaseDataThread(asyncContext,request.getSession());
