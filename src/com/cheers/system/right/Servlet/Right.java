package com.cheers.system.right.Servlet;
...
import com.cheers.system.right.service.RightHandleThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Right"},name="right",asyncSupported=true)
public class Right extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RightHandleThread orgHandleThread = new RightHandleThread(asyncContext,request.getSession());
        asyncContext.start(orgHandleThread);
	}
