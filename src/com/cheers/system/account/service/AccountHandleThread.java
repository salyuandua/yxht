...
public class AccountHandleThread implements Runnable {
	...
	public AccountHandleThread() {
		service = new AccountService();
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public AccountHandleThread(AsyncContext asyncContext) {
		service = new AccountService();
		this.asyncContext = asyncContext;
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public AccountHandleThread(AsyncContext asyncContext,HttpSession session) {
		service = new AccountService();
		this.asyncContext = asyncContext;
