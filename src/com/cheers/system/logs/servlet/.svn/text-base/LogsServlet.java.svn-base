package com.cheers.system.logs.servlet;
...
import com.cheers.system.logs.service.LogsHandleThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Log"},name="log",asyncSupported=true)
public class LogsServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        LogsHandleThread logsHandleThread = new LogsHandleThread(asyncContext,request.getSession());
        asyncContext.start(logsHandleThread);
	}
