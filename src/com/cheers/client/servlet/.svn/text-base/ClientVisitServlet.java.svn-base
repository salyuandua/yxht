...
import com.cheers.client.service.ClientVisitThread;
/** 
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/ClientVisit"},name="clientVisit",asyncSupported=true)
public class ClientVisitServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ClientVisitThread productHandleThread = new ClientVisitThread(asyncContext,request.getSession());
