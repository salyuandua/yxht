 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Client"},name="client",asyncSupported=true)
public class ClientServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ClientThread productHandleThread = new ClientThread(asyncContext,request.getSession());
