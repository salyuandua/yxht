package com.cheers.car.servlet;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Car"},name="car",asyncSupported=true)
public class CarServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		   ...
		   request.setCharacterEncoding("UTF-8");
	        ...
	        CarHandleThread carHandleThread = new CarHandleThread(asyncContext,request.getSession());
