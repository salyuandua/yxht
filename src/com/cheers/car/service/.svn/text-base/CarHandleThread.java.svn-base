...
public class CarHandleThread implements Runnable{
	...
	public CarHandleThread() {
		service = new CarService();
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public CarHandleThread(AsyncContext asyncContext) {
		service = new CarService();
		this.asyncContext = asyncContext;
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public CarHandleThread(AsyncContext asyncContext,HttpSession session) {
		service = new CarService();
		this.asyncContext = asyncContext;
