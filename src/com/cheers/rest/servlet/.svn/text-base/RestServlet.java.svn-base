package com.cheers.rest.servlet;
...
import com.cheers.rest.service.RestThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Rest"},name="rest",asyncSupported=true)
public class RestServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RestThread productHandleThread = new RestThread(asyncContext,request.getSession());
