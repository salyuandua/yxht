 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Export"},name="Export",asyncSupported=true)
public class ExportServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ExportThread productHandleThread = new ExportThread(asyncContext,request.getSession());
