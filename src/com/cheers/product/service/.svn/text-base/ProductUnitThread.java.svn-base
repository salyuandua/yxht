...
public class ProductUnitThread  implements Runnable{
	...
	public ProductUnitThread() {
		service = new ProductUnitService();
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public ProductUnitThread(AsyncContext asyncContext) {
		service = new ProductUnitService();
		this.asyncContext = asyncContext;
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public ProductUnitThread(AsyncContext asyncContext,HttpSession session) {
		service = new ProductUnitService();
		this.asyncContext = asyncContext;
