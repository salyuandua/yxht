...
public class ProductAssignThread  implements Runnable{
	...
	private ProductAssignService service;
	public ProductAssignThread() {
		service = new ProductAssignService();
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public ProductAssignThread(AsyncContext asyncContext) {
		service = new ProductAssignService();
		this.asyncContext = asyncContext;
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public ProductAssignThread(AsyncContext asyncContext,HttpSession session) {
		service = new ProductAssignService();
		this.asyncContext = asyncContext;
