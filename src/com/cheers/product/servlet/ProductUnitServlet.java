...
import com.cheers.product.service.ProductUnitThread;
/** 
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/ProductUnit"},name="productUnit",asyncSupported=true)
public class ProductUnitServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ProductUnitThread productHandleThread = new ProductUnitThread(asyncContext,request.getSession());
