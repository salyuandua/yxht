package com.cheers.goal.servlet;
...
import com.cheers.goal.service.goalThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Goal"},name="goal",asyncSupported=true)
public class goalServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        goalThread productHandleThread = new goalThread(asyncContext,request.getSession());
