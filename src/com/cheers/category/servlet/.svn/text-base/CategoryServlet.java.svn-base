package com.cheers.category.servlet;
...
import com.cheers.category.service.CategoryHandleThread;
 ...
 * @author apple 
 */  
@WebServlet(urlPatterns={"/servlet/Category"},name="category",asyncSupported=true)
public class CategoryServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		   ...
		   request.setCharacterEncoding("UTF-8");
	        ...
	        CategoryHandleThread categoryHandleThread = new CategoryHandleThread(asyncContext,request.getSession());
