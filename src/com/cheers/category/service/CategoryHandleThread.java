...
public class CategoryHandleThread implements Runnable{
	...
	public CategoryHandleThread() {
		service = new CategoryService();
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public CategoryHandleThread(AsyncContext asyncContext) {
		service = new CategoryService();
		this.asyncContext = asyncContext;
		request = (HttpServletRequest)asyncContext.getRequest();
		service.setRequest(request);
	}
	public CategoryHandleThread(AsyncContext asyncContext,HttpSession session) {
		service = new CategoryService();
		this.asyncContext = asyncContext;
